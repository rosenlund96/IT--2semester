	...
	//Initialiser kortene, derefter kan de kaldes.
		private ChanceCard[] init(){
			String[] text = {
					...
					"Ejendomsskatterne er steget ekstraudgifterne er 800kr pr hus 2300kr pr hotel.,0,0,-1000, false, false",
			    	"Ryk frem til Grønningen hvis De passere start. Indkasser da kr. 4000,0,24,0,false,false",
					"Ryk brikken frem til det nærmeste redderi og betal ejeren to gange den leje han ellers er berettiget til. Hvis selskabet ikke ejes af nogen kan De købe det af banken.,0,16,0,false,false",
					"Ryk brikken frem til det nærmeste redderi og betal ejeren to gange den leje han ellers er berettiget til. Hvis selskabet ikke ejes af nogen kan De købe det af banken.,0,6,0,false,false",
					...
					"Oliepriserne er steget og De skal betale kr. 500 pr hus kr. 2000 pr hotel.,0,0,1000, false, false",
