...
public class CardEffect {
	...
	public static final String[] CardText_DATA = {
			...
			"Ryk brikken frem til det n�rmeste redderi og betal ejeren to gange den leje, han ellers er berettiget til. Hvis selskabet ikke ejes af nogen, kan De købe det af banken.",
			"Ryk brikken frem til det n�rmeste redderi og betal ejeren to gange den leje, han ellers er berettiget til. Hvis selskabet ikke ejes af nogen, kan De købe det af banken.",
			...
			"I andledning af kongens fødselsdag benådes de herved for fængsel. Dette kort kan opbevares, indtil de får brug for det, eller de kan sælge det.",
			"Grundet dyrtiden har de fået gageforh�jelse. Modtag kr. 1000",
			...
			"Betal kr. 3000 for reparation af deres vogn.",
			"De modtager det store Matadorlegat for værdigt trængende, kr 40.000. Ved værdigt trængende forstås, at deres formue, dvs. deres kontakte penge, plus skøder, plus penge, ikke overstiger kr. 15.000",
